...
const X = parseFloat(process.env.X || '0'), Z = parseFloat(process.env.Z || '0'), R = parseFloat(process.env.R || '55'), PHI = parseFloat(process.env.PHI || '0.5'), THETA = parseFloat(process.env.THETA || '0');
